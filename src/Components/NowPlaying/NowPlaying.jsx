...
export default function NowPlaying() {
  const [nowPlayingData, setData] = useState([])
  const dispatch = useDispatch()
  useEffect(() => {
    async function nowplayingData(){
      await axios.get(`${process.env.REACT_APP_BASE_URL_ALL}movie/now_playing?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&page=1`)
      .then(ress => {
        // console.log(ress, 'bu now');
  ...
  return (
  <>
    <div className="container-fluid nowPlaying_container">
